        ...
        <div className="py-4">
            <div className="flex flex-col md:flex-row items-center justify-between px-4">
                <div className="mb-4 md:mb-0 flex items-center">
                    ...
                    <div class="relative">
    <img class="w-10 h-10 rounded-full" src={av} alt=""/>
    <span class="top-0 left-7 absolute  w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
</div>

                    <div>
                        <div className="text-2xl  font-extrabold mb-1">Good Evening Team!</div>
                        <div className="text-xs">Have an in-depth look at all the metrics within your dashboard.</div>
                    </div>
                </div>
